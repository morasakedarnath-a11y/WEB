...
// Sync State across Tabs & LocalStorage
function saveState() {
      ...
      <div class="header-container">
        ...
        ` : `
          <div style="display:flex; align-items:center; gap:8px;">
            <button class="view-btn" id="btn-open-staff-modal" style="font-size:0.78rem; opacity:0.8;">
              🔒 Staff Login
            </button>
          </div>
        `}
        ...
        <div class="header-actions">
          <div class="table-badge" id="btn-open-scanner">
            <span>📍 ${state.currentTable.name.split('-')[0]}</span>
            <span style="font-size:0.75rem; opacity:0.8;">[Change]</span>
          </div>
