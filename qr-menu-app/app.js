...
// Helper for fail-safe LocalStorage parsing (prevents blank screen on corrupted browser cache)
  ...
  return `
    <header class="app-header">
      <div class="header-container">
        ...
        ${state.mode === 'customer' ? `
          <button class="view-btn" id="btn-open-staff-modal" style="font-size:0.75rem; padding:4px 10px; opacity:0.8; background:rgba(255,255,255,0.06);">
            🔐 Staff Access
          </button>
        ` : ''}
